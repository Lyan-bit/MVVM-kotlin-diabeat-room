...
class ListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        model = DiabeatsCRUDViewModel.getInstance(myContext)
    ...
    override fun onResume() {
        super.onResume()
        model.allDiabeatss.observe( this) { diabeats ->
            diabeats.let {
                (root as RecyclerView).adapter = ClassificationRecyclerViewAdapter(diabeats, mListener!!)
            }
        }
    }
    ...
    interface OnListFragmentInteractionListener {
        fun onListFragmentInteraction(item: DiabeatsEntity)
    }
}
