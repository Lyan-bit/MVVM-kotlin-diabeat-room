...
class ClassificationRecyclerViewAdapter(items: List<DiabeatsEntity>, listener: ListFragment.OnListFragmentInteractionListener)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.listClassificationthreeView.text = " " + mValues[position].glucose + " "
